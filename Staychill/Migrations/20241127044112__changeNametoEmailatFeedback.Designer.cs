...
namespace Staychill.Migrations
{
    ...
    [Migration("20241127044112__changeNametoEmailatFeedback")]
    partial class _changeNametoEmailatFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Staychill.Models.BankModel.CreditcardType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CreditcardOpt")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Staychill.Models.UserModel.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Staychill.ViewModel.ShipmentViewModel", b =>
                {
                    b.PrimitiveCollection<string>("SelectedCartItemIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Staychill.Models.BankModel.CreditcardType", b =>
                {
                    b.HasOne("Staychill.Models.BankModel.CreditCard", null)
                        .WithMany("CardTypeOpt")
